...
class SegModel(nn.Module):
    def __init__(self, bert_type, vision_type, project_dim=512, prototype=None):
        ...
        self.approx1 = GuidedApproximation(512, 3, feature_dim[0], feature_dim[1], 768)
        self.approx2 = GuidedApproximation(512, 3, feature_dim[1], feature_dim[2], 768)
        self.approx3 = GuidedApproximation(512, 3, feature_dim[2], feature_dim[3], 768)
